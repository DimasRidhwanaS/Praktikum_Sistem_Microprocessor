...
_main:
; .FSTART _main
; 0000 0008 UCSR0B=0x00;
	LDI  R30,LOW(0)
	STS  193,R30
; 0000 0009 DDRD = 0xFF;                    // Using PD4      -> 0b00010000
	LDI  R30,LOW(255)
	OUT  0xA,R30
; 0000 000A 
; 0000 000B while (1)
_0x3:
; 0000 000C {
; 0000 000D PORTD = 0b00000001;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x0
; 0000 000E delay_ms(1000);
; 0000 000F PORTD = 0b00000010;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 0010 delay_ms(1000);
; 0000 0011 PORTD = 0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
; 0000 0012 delay_ms(1000);
; 0000 0013 PORTD = 0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x0
; 0000 0014 delay_ms(1000);
; 0000 0015 PORTD = 0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x0
; 0000 0016 delay_ms(1000);
; 0000 0017 PORTD = 0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 0018 delay_ms(1000);
; 0000 0019 PORTD = 0b01000000;
	LDI  R30,LOW(64)
	RCALL SUBOPT_0x0
; 0000 001A delay_ms(1000);
; 0000 001B PORTD = 0b10000000;
	LDI  R30,LOW(128)
	RCALL SUBOPT_0x0
