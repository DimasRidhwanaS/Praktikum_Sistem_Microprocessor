...
// //SET COUNT VALUE FOR 1 HZ
// #define TCNT_HIGH 0x00
// #define TCNT_LOW 0x00

// // Fungsi untuk mengatur LED berdasarkan pola tertentu
// void setLED(int state) {
//     PORTB = (state == 1) ? 0b10101010 : 0b01010101; // Mengatur output port sesuai pola ON/OFF
// }
...
// // Interrupt Service Routine untuk overflow timer 1
// interrupt [TIM1_OVF] void timer1_ovf_isr(void) { 
//     // Set LED OFF
//     setLED(0);
// }
...
//     while (1) {
//         // Looping untuk pola nyala LED
//         for (i = 0; i < 8; i++) {
//             setLED((i % 2 == 0) ? 1 : 0); // Mengatur LED ON/OFF sesuai pola
